const Needs = () => {
  return (
    <section
      id="needs"
      className="container mx-auto sm:px-[16px] md:px-[40px] lg:px-[60px] sm:py-[60px]"
    >
      <h2 className="mb-[32px] lg:mb-[24px] text-center lg:text-left title text-[56px] leading-1.2 text-blue-sky">
        Потреби
      </h2>
      <p className="lg:hidden sm:mb-[32px] text text-[18px] leading-[21px] text-blue-sky text-left">
      ...
      <p className="lg:hidden text text-[18px] leading-[21px] mb-[40px] text-blue-sky text-left">
        Військовослужбовці рятують наше життя щосекунди - врятуймо ми й їхнє,
        задонативши на потреби Госпіталя!
      </p>
      <button className="lg:hidden inline-block sm:w-[343px] md:w-[312px] h-[88px] p-4 bg-light-blue title hover:bg-active-btn focus:bg-active-btn text-black text-[40px] leading-1.2 rounded-2xl shadow-donateBoxShadow transition-all">
        Зробити донат
      </button>
      {/* Deskop */}
      <div className="hidden lg:flex">
        <div className="left-side w-[648px] mr-[25px]">
          <p className="mb-[24px] text text-[18px] leading-[21px] text-blue-sky text-left">
            Щодня на придбання Омепразол - порошок для р-ну д/інф. по 40 мг №1 у
